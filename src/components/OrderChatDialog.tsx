...
export const OrderChatDialog = ({ open, onClose, order, vendorId, vendorName }: OrderChatDialogProps) => {
  ...
  return (
    <>
      ...
      <div 
        className="fixed inset-0 md:inset-auto md:bottom-4 md:right-4 w-full md:w-96 h-full md:h-[500px] max-w-2xl mx-auto md:mx-0 bg-card rounded-none md:rounded-lg border-0 md:border md:border-border shadow-2xl flex flex-col z-[9999]"
