...
export const OrderChatDialog = ({ open, onClose, order, vendorId, vendorName }: OrderChatDialogProps) => {
  ...
  return (
    <>
      ...
      <div 
        className="fixed top-0 left-0 right-0 bottom-32 md:inset-auto md:bottom-4 md:right-4 w-full md:w-96 h-auto md:h-[500px] max-w-2xl mx-auto md:mx-0 bg-card rounded-b-lg md:rounded-lg border-0 md:border md:border-border shadow-2xl flex flex-col z-[9999]"
