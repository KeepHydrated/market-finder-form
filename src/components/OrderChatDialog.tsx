...
export const OrderChatDialog = ({ open, onClose, order, vendorId, vendorName }: OrderChatDialogProps) => {
  ...
  return (
    <>
      ...
      <div 
        className="fixed inset-0 md:inset-auto md:bottom-4 md:right-4 w-full h-full md:w-96 md:h-[500px] bg-card rounded-none md:rounded-lg border-0 md:border md:border-border shadow-2xl flex flex-col z-[9999]"
