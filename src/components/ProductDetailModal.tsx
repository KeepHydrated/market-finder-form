      ...
      <DialogContent className="sm:max-w-[700px] max-h-[80vh] overflow-y-auto p-0 gap-0 [&>button[data-radix-dialog-close]]:hidden bg-white">
        ...
        {hasPrevious && (
          <Button
            ...
            className="fixed left-[calc(50vw-450px)] top-1/2 transform -translate-y-1/2 z-50 h-12 w-12 p-0 bg-black/80 hover:bg-black text-white shadow-lg rounded-full"
          >
        ...
        {hasNext && (
          <Button
            ...
            size="lg" 
            onClick={goToNext}
            className="fixed right-[calc(50vw-450px)] top-1/2 transform -translate-y-1/2 z-50 h-12 w-12 p-0 bg-black/80 hover:bg-black text-white shadow-lg rounded-full"
          >
          ...
          <div className="w-1/2 relative bg-gray-50">
            ...
            <div className="w-1/2 p-4 flex flex-col justify-start bg-white border-l border-gray-100">
              ...
              <div className="space-y-3 flex-1">
                ...
                {/* Add to Cart Section */}
                {vendorId && vendorName && (
                  <div className="space-y-3 pt-3 border-t border-gray-200 mt-auto">
                    <Button
