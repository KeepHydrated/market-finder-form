            ...
            <div key={order.id} className="grid md:grid-cols-[1fr,280px] gap-6">
              ...
              <Card className="overflow-hidden hidden md:block">
                ...
                <CardContent className="pt-0">
                  ...
                  <div className="space-y-3 max-h-[150px] overflow-y-auto pr-2 border rounded-md p-2">
                ...
                >
                  ...
                  >
                    ...
                    <CardContent className="pt-0 pb-0">
                      ...
                      <div className="space-y-2 max-h-[150px] overflow-y-auto pr-2 border rounded-md p-2">
                        {order.order_items.map((item) => (
