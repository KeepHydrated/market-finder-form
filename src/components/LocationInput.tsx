      ...
      <div className="relative">
        <div className="relative">
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-base border border-border rounded-lg focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0 bg-background text-foreground placeholder:text-muted-foreground"
            value={value}
