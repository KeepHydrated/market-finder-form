      ...
      <div className="relative">
        <div className="relative">
          <input
            ...
            className="w-full pl-10 pr-4 py-3 text-base border-2 border-border rounded-lg focus:ring-0 focus:ring-offset-0 bg-background text-foreground placeholder:text-muted-foreground"
            value={value}
