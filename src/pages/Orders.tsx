                    ...
                    {order.order_items.map((item) => (
                      <div key={item.id} className="flex items-start gap-3 py-2">
                        <button
                          ...
                          className="w-20 h-20 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden hover:opacity-80 transition-opacity focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                        >
                          {item.product_image ? (
                            <img 
                      ...
                      <div className="space-y-1 max-h-[140px] overflow-y-auto">
                        {order.order_items.map((item) => (
                          <div key={item.id} className="flex items-start gap-2 py-1">
                            <button
                              onClick={() => handleProductClick(item, order.vendor_id, order.vendor_name)}
                              className="w-16 h-16 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden hover:opacity-80 transition-opacity"
                            >
                              {item.product_image ? (
                                <img 
                                  src={item.product_image} 
