...
export default function ShopManager() {
  ...
  const renderContent = () => {
    ...
    switch (currentSection) {
      ...
      case 'orders2':
        return (
          <div className="space-y-6 ml-4 sm:ml-52 mr-4 sm:mr-8 max-w-6xl pt-6 sm:pt-[40px] pb-4">
  ...
  const renderOverviewWithTabs = () => (
    <div className="space-y-6 ml-4 sm:ml-52 mr-4 sm:mr-8 max-w-7xl pt-6 sm:pt-[40px] pb-4">
      {renderTest()}
    </div>
  );
  ...
  const renderShop = () => (
    <div className="space-y-6 ml-4 sm:ml-52 mr-4 sm:mr-8 max-w-3xl pt-6 sm:pt-[40px] pb-4">
      <div className="flex items-start justify-between">
        <div>
